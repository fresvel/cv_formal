...
\begin{levent}
	...
	{
	Diseño y supervisión de proyectos de cableado estructurado, asegurando infraestructura segura y optimizada para la monitorización de redes.\\
	Clasificación y asignación de requerimientos tecnológicos mediante herramientas de mesa de servicio, gestionando incidentes de seguridad y escalamiento.\\
	Administración de redes Cisco (cableadas e Inalámbricas), integrando herramientas de monitoreo.\\
	Gestión de sistemas operativos Windows y Linux, aplicando políticas de seguridad, actualizaciones y monitoreo para la identificación de incidentes.\\
	Soporte técnico en ofimática y aplicaciones bancarias, gestionando incidentes y garantizando la seguridad de datos y operaciones.\\
	Instalación, mantenimiento y reparación de equipos (hardware y software), garantizando seguridad y rendimiento de los sistemas ante posibles incidentes.\\
    }
